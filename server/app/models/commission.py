...
class CommissionConfig(Base):
    ...
    level1_rate: Mapped[float] = mapped_column(DECIMAL(5, 2), nullable=False, default=5.00)
    level2_rate: Mapped[float] = mapped_column(DECIMAL(5, 2), nullable=False, default=2.00)
...
class CommissionFlow(Base):
    ...
    rate: Mapped[float] = mapped_column(DECIMAL(5, 2), nullable=False)
    base_amount: Mapped[float] = mapped_column(DECIMAL(18, 2), nullable=False)
    commission_amount: Mapped[float] = mapped_column(DECIMAL(18, 2), nullable=False)
