...
from sqlalchemy import DECIMAL, BigInteger, DateTime, Enum, ForeignKey, String, func
...
class Package(TimestampMixin, Base):
    ...
    package_price: Mapped[Decimal] = mapped_column(DECIMAL(18, 2), nullable=False)
    package_type: Mapped[str] = mapped_column(String(32), nullable=False)
    voucher_reward_rate: Mapped[Decimal] = mapped_column(DECIMAL(5, 2), default=100.00, nullable=False)
    referral_voucher_rate: Mapped[Decimal] = mapped_column(DECIMAL(5, 2), default=50.00, nullable=False)
    ai_coupon_max_deduct_rate: Mapped[Decimal] = mapped_column(DECIMAL(5, 2), default=20.00, nullable=False)
