...
CREATE TABLE IF NOT EXISTS product_zone_configs (
    ...
    balance_purchase_enabled TINYINT(1) NOT NULL DEFAULT 1,
    alipay_purchase_enabled TINYINT(1) NOT NULL DEFAULT 1,
    wechat_purchase_enabled TINYINT(1) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS payment_refunds (
    ...
    UNIQUE KEY uk_payment_refunds_transaction_idempotency (payment_transaction_id, idempotency_key),
    ...
    CONSTRAINT fk_payment_refunds_payment_transaction_id FOREIGN KEY (payment_transaction_id) REFERENCES payment_transactions (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
