  ...
  <view class="container service-detail-page">
    ...
    <template v-else>
      <view class="card hero-card">
        <view class="badge badge-orange">服务详情</view>
      ...
      <button class="btn btn-primary mt-24" @click="book">立即预约</button>
    </template>
  </view>
</template>
...
.hero-card {
  background:
    radial-gradient(circle at 96% 8%, rgba(255, 166, 82, 0.2), transparent 38%),
...
.price { font-size: 44rpx; color: #c96a14; font-weight: 800; }
