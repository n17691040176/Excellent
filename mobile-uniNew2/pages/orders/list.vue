...
.board { background: radial-gradient(circle at 95% 6%, rgba(208, 174, 136, 0.22), transparent 40%), #ffffff; border: 1rpx solid rgba(197,160,123,.2); }
.board-title { font-size: 34rpx; font-weight: 800; color: #4d3420; letter-spacing: 0.6rpx; }
...
.stat-card { border-radius: 16rpx; padding: 14rpx; background: #fbf5ef; border: 1rpx solid rgba(198,161,124,.16); }
.stat-num { font-size: 34rpx; color: #8e5f35; font-weight: 800; letter-spacing: 0.3rpx; }
.stat-label { margin-top: 4rpx; font-size: 22rpx; color: #8c735c; }
.status-wrap { display: flex; gap: 12rpx; overflow-x: auto; }
.status-chip { flex-shrink: 0; padding: 10rpx 20rpx; border-radius: 999rpx; background: #f6f1ea; color: #7f6954; font-size: 24rpx; border: 1rpx solid rgba(194,156,117,.18); }
.status-chip.active { background: #bf8752; color: #ffffff; border-color: #bf8752; }
.order-card { margin-bottom: 16rpx; border: 1rpx solid rgba(198,161,125,.18); box-shadow: 0 12rpx 28rpx rgba(141, 101, 62, 0.08); border-radius: 20rpx; }
.order-no { font-size: 23rpx; color: #8d755d; }
.order-title { margin-top: 12rpx; font-size: 30rpx; font-weight: 700; color: #503522; letter-spacing: 0.4rpx; }
.order-meta { margin-top: 8rpx; font-size: 23rpx; color: #7d6753; }
.order-extra { margin-top: 8rpx; font-size: 22rpx; color: #a06d3d; }
.order-price { font-size: 36rpx; color: #9b6434; font-weight: 800; letter-spacing: 0.5rpx; }
