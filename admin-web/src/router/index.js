...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/region-stats', component: () => import('@/views/region/RegionStatsView.vue'), meta: { roles: ['SUPER_ADMIN', 'TEAM_ADMIN'], title: '区域订单统计', permission: 'region:view' } },
      { path: '/commission', component: () => import('@/views/commission/CommissionView.vue'), meta: { roles: ['SUPER_ADMIN', 'TEAM_ADMIN'], title: '返现管理', permission: 'commission:view' } },
