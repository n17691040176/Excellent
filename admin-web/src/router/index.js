...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/orders', component: () => import('@/views/orders/OrderListView.vue'), meta: { roles: ['SUPER_ADMIN', 'TEAM_ADMIN'], title: '订单管理' } },
      ...
      { path: '/system/earning-rules', component: () => import('@/views/system/EarningRuleView.vue'), meta: { roles: ['SUPER_ADMIN'], title: '收益规则' } },
